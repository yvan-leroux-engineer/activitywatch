...
export const useViewsStore = defineStore('views', {
  ...
  actions: {
    ...
    loadViews(views: View[]) {
      this.$patch({ views });
      // Removed console.log to avoid [object Object] warnings
    },
    ...
    editView(
      ...
      console.log('Edit view:', view_id, el_id, type, JSON.stringify(props));
      // Removed console.log(this.views) to avoid [object Object] warnings
