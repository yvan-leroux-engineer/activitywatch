...
# Collect PyQt6 package files
import PyQt6
pyqt6_path = Path(PyQt6.__file__).parent
pyqt6_datas = []
if pyqt6_path.exists():
    # Include all Python files from PyQt6 package
    for py_file in pyqt6_path.glob("*.py"):
        pyqt6_datas.append((str(py_file), "PyQt6"))
    # Include __init__.py specifically
    init_py = pyqt6_path / "__init__.py"
    if init_py.exists():
        pyqt6_datas.append((str(init_py), "PyQt6"))
...
if platform.system() == "Darwin":
    app = BUNDLE(
        ...
        icon=icon,
        bundle_identifier="net.activitywatch.ActivityWatch.dev",
        version=current_release.lstrip("v"),
        info_plist={
            "NSPrincipalClass": "NSApplication",
            "CFBundleExecutable": "aw-qt",
            "CFBundleIconFile": "logo.icns",
            "CFBundleName": "ActivityWatch Dev",
            "CFBundleDisplayName": "ActivityWatch Dev",
