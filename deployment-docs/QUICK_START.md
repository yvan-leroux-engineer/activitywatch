...
3. Verify config: `cat ~/Library/Application\ Support/activitywatch/aw-client/aw-client.toml`

## 📝 Configuration Location

Config file: `~/Library/Application Support/activitywatch/aw-client/aw-client.toml`
